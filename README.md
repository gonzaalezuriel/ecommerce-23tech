...
El sistema implementa 20 casos de uso (CU001-CU020) que cubren la administración de usuarios, productos, categorías, manejo del carrito de compras, historial y checkout.

Todos los Requisitos No Funcionales (RNF) y las Validaciones de Datos están implementados según la especificación formal del proyecto.

> 📄 Para la especificación detallada de cada caso de uso, requisitos no funcionales y validaciones, ver el [`Archivo de Requerimientos`](docs/Archivo_de_Requerimientos.md).
